...
class Boot extends Phaser.Scene {
  ...
  preload() {
    ...
    for (let i = 1; i <= 4; i++) this.load.image(`decor_rock_${i}`, `/assets/scenes/decor_rock_${i}.png`);
    for (let i = 1; i <= 4; i++) this.load.image(`decor_bush_${i}`, `/assets/scenes/decor_bush_${i}.png`);
  }
  create() {
