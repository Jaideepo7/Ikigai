...
Keys: WASD / arrows move · `E` interact · `Enter` chat · `P T M I Q` panels · `Esc` settings/close.

## Repository layout

```text
design/            mockups + sprite sheets from the team (source of truth for art)
tools/extract_assets.py   turns design/ into public/assets/ (run after changing art)
public/assets/     generated sprites, scenes, icons, cards, map
...
* No side-view character art exists, so left/right use the front sprite (mirrored) with a bob. Add sheets later.
